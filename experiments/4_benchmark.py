...
DATASETS = {
    "breast_cancer": lambda: _openml(data_id=15),
    "ionosphere":    lambda: _openml(data_id=59),
    "ecoli":         lambda: _openml(data_id=20),
    "glass":         lambda: _openml(data_id=41),
    "magic":         lambda: _openml(data_id=1120),       
    "covertype":     lambda: _openml(data_id=1596),       
    "spambase":      lambda: _openml(data_id=44),         
    "adult":         lambda: _openml(name="adult", version=2),       
    "bank":          lambda: _openml(name="bank-marketing", version=1),  
    "letter":        lambda: _openml(data_id=6),          
    "jannis":        lambda: _openml(name="jannis", version=1),      
